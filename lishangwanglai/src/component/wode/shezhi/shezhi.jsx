...
export default class wode extends Component{
    ...
    render(){
        return(
            <div id="shezhi">
              <NavLink to="/wode">
                    <div id="shezhi-img"><img src="http://www.axshare.cn/gsc/9B0J2A/6b/b2/f3/6bb2f30d8aa742729e588769883d60fd/images/礼账列表/u84.png?token=33322991ede4fde3424b1dc4dc59c0daeffe02755274fee6b5bd9b4a11eb5627" /></div>
              </NavLink>
              <p>设置</p>
              <ul id="shezhi-ul">
